...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `skill_strength` int unsigned NOT NULL DEFAULT 10,
  `skill_strength_tries` bigint unsigned NOT NULL DEFAULT 0,
  ...
  `skill_szybkosc` int unsigned NOT NULL DEFAULT 10,
  `skill_szybkosc_tries` bigint unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
