...
ShootTypeNames shootTypeNames = {
    ...
    {"szescdziesiatpiec", CONST_ANI_SZESCDZIESIATPIEC},
    {"szescdziesiatszesc", CONST_ANI_SZESCDZIESIATSZESC},
    {"szescdziesiatsiedem", CONST_ANI_SZESCDZIESIATsiedem},
    {"szescdziesiatosiem", CONST_ANI_SZESCDZIESIATOSIEM},
    {"szescdziesiatdziewiec", CONST_ANI_SZESCDZIESIATDZIEWIEC},
    {"siedemdziesiat", CONST_ANI_SIEDEMDZIESIAT},
    {"siedemdziesiatjeden", CONST_ANI_SIEDEMDZIESIATJEDEN},
    {"siedemdziesiatdwa", CONST_ANI_SIEDEMDZIESIATDWA},
    {"siedemdziesiattrzv", CONST_ANI_SIEDEMDZIESIATTRZV},
    {"siedemdziesiatcztery", CONST_ANI_SIEDEMDZIESIATCZTERY},
    {"siedemdziesiatpiec", CONST_ANI_SIEDEMDZIESIATPIEC},
    {"siedemdziesiatszesc", CONST_ANI_SIEDEMDZIESIATSZESC},
    {"siedemdziesiatsiedem", CONST_ANI_SIEDEMDZIESIATSIEDEM},
    {"siedemdziesiatosiem", CONST_ANI_SIEDEMDZIESIATOSIEM},
    {"siedemdziesiatdziewiec", CONST_ANI_SIEDEMDZIESIATDZIEWIEC},
    {"osiemdziesiat", CONST_ANI_OSIEMDZIESIAT},
    {"osiemdziesiatjeden", CONST_ANI_OSIEMDZIESIATJEDEN},
    {"osiemdziesiatdwa", CONST_ANI_OSIEMDZIESIATDWA},
    {"osiemdziesiattrzv", CONST_ANI_OSIEMDZIESIATTRZV},
    {"osiemdziesiatcztery", CONST_ANI_OSIEMDZIESIATCZTERY},
    {"osiemdziesiatpiec", CONST_ANI_OSIEMDZIESIATPIEC},
    {"osiemdziesiatszesc", CONST_ANI_OSIEMDZIESIATSZESC},
    {"osiemdziesiatsiedem", CONST_ANI_OSIEMDZIESIATSIEDEM},
    {"osiemdziesiatosiem", CONST_ANI_OSIEMDZIESIATOSIEM},
    {"osiemdziesiatdziewiec", CONST_ANI_OSIEMDZIESIATDZIEWIEC},
    {"dziewiecdziesiat", CONST_ANI_DZIEWIECDZIESIAT},
    {"dziewiecdziesiatjeden", CONST_ANI_DZIEWIECDZIESIATJEDEN},
    {"dziewiecdziesiatdwa", CONST_ANI_DZIEWIECDZIESIATDWA},
    {"dziewiecdziesiattrzv", CONST_ANI_DZIEWIECDZIESIATTRZV},
    {"dziewiecdziesiatcztery", CONST_ANI_DZIEWIECDZIESIATCZTERY},
    {"dziewiecdziesiatpiec", CONST_ANI_DZIEWIECDZIESIATPIEC},
    {"dziewiecdziesiatszesc", CONST_ANI_DZIEWIECDZIESIATSZESC},
    {"dziewiecdziesiatsiedem", CONST_ANI_DZIEWIECDZIESIATSIEDEM},
    {"dziewiecdziesiatosiem", CONST_ANI_DZIEWIECDZIESIATOSIEM},
    {"dziewiecdziesiatdziewiec", CONST_ANI_DZIEWIECDZIESIATDZIEWIEC},
    {"sto", CONST_ANI_STO},
    {"stojeden", CONST_ANI_STOJEDEN},
    {"stodwa", CONST_ANI_STODWA},
    {"stotrzv", CONST_ANI_STOTRZV},
    {"stocztery", CONST_ANI_STOCZTERY},
    {"stopiec", CONST_ANI_STOPIEC},
    {"stoszesc", CONST_ANI_STOSZESC},
